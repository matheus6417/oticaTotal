    ...
    ! function (t) {
      ...
      function i(t) {
        u.env() && (v(t.design) && h.on("__wf_design", t.design), v(t.preview) && h.on("__wf_preview", t.preview)),
          v(t.destroy) && h.on("__wf_destroy", t.destroy), t.ready && v(t.ready) && function (t) {
      ...
      function r(t) {
        v(t.design) && h.off("__wf_design", t.design), v(t.preview) && h.off("__wf_preview", t.preview), v(t.destroy) &&
          h.off("__wf_destroy", t.destroy), t.ready && v(t.ready) && function (t) {
      ...
      g.config.hideBackface = !1, g.config.keepInherited = !0, u.define = function (t, e, n) {
        ...
        return t ? "design" === t ? n && e : "preview" === t ? n && !e : "slug" === t ? n && window.__wf_slug :
          "editor" === t ? window.WebflowEditor : "test" === t ? window.__wf_test : "frame" === t ? window !==
          window.top : void 0 : n
      };
      var y = navigator.userAgent.toLowerCase(),
        x = u.env.touch = "ontouchstart" in window || window.DocumentTouch && document instanceof window.DocumentTouch,
        k = u.env.chrome = /chrome/.test(y) && /Google/.test(navigator.vendor) && parseInt(y.match(
          /chrome\/(\d+)\./)[1], 10),
      ...
      u.resize = o(h, O), u.scroll = o(h, "scroll.webflow resize.webflow orientationchange.webflow load.webflow"),
        u.redraw = o(), u.location = function (t) {
          window.location = t
      ...
      u.load = function (t) {
        ...
        t = t || {}, b = !0, h.triggerHandler("__wf_destroy"), null != t.domready && (w = t.domready), m.each(c,
          r), u.resize.off(), u.scroll.off(), u.redraw.off(), l = [], d = [], "pending" === z.state() && s()
      ...
      window.tram = function (t) {
        ...
        function s(t, e, n) {
          ...
          var i = n;
          return Y.test(t) || !G.test(t) ? i = parseInt(t, 10) : G.test(t) && (i = 1e3 * parseFloat(t)), 0 > i &&
            (i = 0), i == i ? i : n
        }
        ...
        var c = function (t, e, i) {
          ...
          l = {
            ...
            "ease-in-out-quint": ["cubic-bezier(0.860, 0, 0.070, 1)", function (t, e, n, i) {
              return (t /= i / 2) < 1 ? n / 2 * t * t * t * t * t + e : n / 2 * ((t -= 2) * t * t * t * t + 2) +
                e
            }],
            ...
            "ease-in-out-expo": ["cubic-bezier(1, 0, 0, 1)", function (t, e, n, i) {
              return 0 === t ? e : t === i ? e + n : (t /= i / 2) < 1 ? n / 2 * Math.pow(2, 10 * (t - 1)) + e :
            ...
            "ease-in-out-circ": ["cubic-bezier(0.785, 0.135, 0.150, 0.860)", function (t, e, n, i) {
              return (t /= i / 2) < 1 ? -n / 2 * (Math.sqrt(1 - t * t) - 1) + e : n / 2 * (Math.sqrt(1 - (t -=
                2) * t) + 1) + e
            }],
            ...
            "ease-in-out-back": ["cubic-bezier(0.680, -0.550, 0.265, 1.550)", function (t, e, n, i, r) {
              return void 0 === r && (r = 1.70158), (t /= i / 2) < 1 ? n / 2 * t * t * ((1 + (r *= 1.525)) *
                t - r) + e : n / 2 * ((t -= 2) * t * ((1 + (r *= 1.525)) * t + r) + 2) + e
            }]
          },
          d = {
        ...
        var L = e.frame = function () {
            var t = h.requestAnimationFrame || h.webkitRequestAnimationFrame || h.mozRequestAnimationFrame || h.oRequestAnimationFrame ||
          ...
          A = c(function (e) {
            ...
            function o(t, e, i) {
              if (t) {
                ...
                if (e || (this.timer && this.timer.destroy(), this.queue = [], this.active = !1), "number" == o &&
            ...
            function c(t) {
              ...
              var e;
              "string" == typeof t ? (e = {}, e[t] = 1) : e = "object" == (void 0 === t ? "undefined" : n(t)) &&
                null != t ? t : this.props, h.call(this, e, v), f.call(this)
            }
            ...
            function h(t, e, n) {
              var o, a, s, u, c = e !== v,
                l = {};
              for (o in t) s = t[o], o in Z ? (l.transform || (l.transform = {}), l.transform[o] = s) : (m.test(
                o) && (o = i(o)), o in U ? l[o] = s : (u || (u = {}), u[o] = s));
              for (o in l) {
            ...
            e.init = function (e) {
              if (this.$el = t(e), this.el = this.$el[0], this.props = {}, this.queue = [], this.style = "",
                this.active = !1, F.keepInherited && !F.fallback) {
          ...
          S = c(function (t) {
            ...
            t.init = function (t, e, n, o) {
              ...
              var u = e[0];
              n[2] && (u = n[2]), X[u] && (u = X[u]), this.name = u, this.type = n[1], this.duration = s(e[1],
                  this.duration, i), this.ease = function (t, e, n) {
                  return void 0 !== e && (n = e), t in l ? t : n
                }(e[2], this.ease, r), this.delay = s(e[3], this.delay, a), this.span = this.duration + this.delay,
                this.active = !1, this.nextStyle = null, this.auto = k.test(this.name), this.unit = o.unit ||
                this.unit || F.defaultUnit, this.angle = o.angle || this.angle || F.defaultAngle, F.fallback ||
                o.fallback ? this.animate = this.fallback : (this.animate = this.transition, this.string =
                  this.name + _ + this.duration + "ms" + ("ease" != this.ease ? _ + l[this.ease][0] : "") + (
                    this.delay ? _ + this.delay + "ms" : ""))
            }, t.set = function (t) {
              t = this.convert(t, this.type), this.update(t), this.redraw()
            }, t.transition = function (t) {
              this.active = !0, t = this.convert(t, this.type), this.auto && ("auto" == this.el.style[this.name] &&
                  (this.update(this.get()), this.redraw()), "auto" == t && (t = e.call(this))), this.nextStyle =
                t
            }, t.fallback = function (t) {
              var n = this.el.style[this.name] || this.convert(this.get(), this.type);
              t = this.convert(t, this.type), this.auto && ("auto" == n && (n = this.convert(this.get(), this
                .type)), "auto" == t && (t = e.call(this))), this.tween = new N({
                from: n,
                to: t,
              ...
              (this.active || this.nextStyle) && (this.active = !1, this.nextStyle = null, H(this.el, this.name,
                this.get()));
              var t = this.tween;
              ...
              return function (t, e) {
                u("Type warning: Expected: [" + t + "] Got: [" + (void 0 === e ? "undefined" : n(e)) + "] " +
                  e)
              }(i, t), t
            }, t.redraw = function () {
              this.el.offsetHeight
          ...
          D = c(S, function (t, e) {
            ...
            t.init = function () {
              e.init.apply(this, arguments), this.current || (this.current = {}, Z.perspective && F.perspective &&
                (this.current.perspective = F.perspective, H(this.el, this.name, this.style(this.current)),
                  this.redraw()))
            }, t.set = function (t) {
              ...
              return n.call(this, t, function (t, n, r) {
                i[t] = n, void 0 === this.current[t] && (e = 0, ~t.indexOf("scale") && (e = 1), this.current[
                  t] = this.convert(e, r))
              }), i
            }
          }),
          N = c(function (e) {
            ...
            e.init = function (t) {
              ...
              var e = t.ease || i.ease;
              l[e] && (e = l[e][1]), "function" != typeof e && (e = i.ease), this.ease = e, this.update = t.update ||
                a, this.complete = t.complete || a, this.context = t.context || this, this.name = t.name;
              var n = t.from,
                r = t.to;
              void 0 === n && (n = i.from), void 0 === r && (r = i.to), this.unit = t.unit || "", "number" ==
                typeof n && "number" == typeof r ? (this.begin = n, this.change = r - n) : this.format(r, n),
                this.value = this.begin + this.unit, this.start = I(), !1 !== t.autoplay && this.play()
            }, e.play = function () {
              ...
              if (n < this.duration) {
                ...
                }(this.begin + i * this.change), this.value = e + this.unit, void this.update.call(this.context,
                  this.value)
              }
              e = this.endHex || this.begin + this.change, this.value = e + this.unit, this.update.call(this.context,
                this.value), this.complete.call(this.context), this.destroy()
            }, e.format = function (t, e) {
              if (e += "", "#" == (t += "").charAt(0)) return this.startRGB = r(e), this.endRGB = r(t), this.endHex =
                t, this.begin = 0, void(this.change = 1);
              if (!this.unit) {
                var n = e.replace(v, "");
          ...
          P = c(N, function (t) {
            t.init = function (t) {
              this.duration = t.duration || 0, this.complete = t.complete || a, this.context = t.context,
                this.play()
            }, t.render = function (t) {
          ...
          B = c(N, function (t, e) {
            t.init = function (t) {
              ...
              var e, n, i = !1;
              for (e = this.tweens.length; e--;)(n = this.tweens[e]).context && (n.render(t), this.current[n.name] =
                n.value, i = !0);
        ...
        C.transform && (U.transform = [D], Z = {
          ...
          skewX: [y],
          skewY: [y]
        }), C.transform && C.backface && (Z.z = [b, "translateZ"], Z.rotateZ = [y], Z.scaleZ = ["number"], Z.perspective = [
          w
        ]);
        var Y = /ms/,
          G = /s|\./;
      ...
      t.exports = function () {
        ...
        return t.template = function (e, n, i) {
          ...
          var r = RegExp([(n.escape || m).source, (n.interpolate || m).source, (n.evaluate || m).source].join(
              "|") + "|$", "g"),
            o = 0,
            a = "__p+='";
        ...
        return r.ready = function () {
          ...
          /\.webflow\.io$/i.test(r) && u.hostname !== r && (i = !0), i && !c && (n = n || function () {
            var e = t('<a class="w-webflow-badge"></a>').attr("href",
              ...
              n = t("<img>").attr("src",
                "https://d1otoma47x30pg.cloudfront.net/img/webflow-badge-icon.60efbf6ec9.svg").css({
                marginRight: "8px",
                width: "16px"
              }),
              i = t("<img>").attr("src",
      ...
      i.define("dropdown", t.exports = function (t, e) {
        ...
        function o(n, r) {
          ...
          l || (l = t.data(r, m, {
              ...
              el: o,
              config: {}
            })), l.list = o.children(".w-dropdown-list"), l.toggle = o.children(".w-dropdown-toggle"), l.links =
            l.list.children(".w-dropdown-link"), l.outside = function (n) {
            ...
            }(l), o.off(m), l.toggle.off(m), a(l), l.nav && l.nav.off(m), l.nav = o.closest(".w-nav"), l.nav.on(
              w, s(l)), d ? o.on("setting" + m, s(l)) : (l.toggle.on("tap" + m, function (t) {
        ...
        function s(t) {
          return function (e, n) {
            return n = n || {}, "w-close" === e.type ? c(t) : "setting" === e.type ? (a(t), !0 === n.open &&
              u(t), void(!1 === n.open && c(t, !0))) : void 0
          }
        }
        ...
        function u(e) {
          if (!e.open) {
            ...
            }(e), e.open = !0, e.list.addClass(g), e.toggle.addClass(g), b.intro(0, e.el[0]), i.redraw.up(), e.manageZ &&
              e.el.css("z-index", y + 1);
            var n = i.env("editor");
            d || h.on("mouseup" + m, e.outside), e.hovering && !n && e.el.on("mouseleave" + m, e.leave), e.hovering &&
              n && h.on("mousemove" + m, e.moveOutside), window.clearTimeout(e.delayId)
          }
        }
        ...
        function c(t, e) {
          if (t.open && (!t.config.hover || !t.hovering)) {
            t.open = !1;
            var n = t.config;
            if (b.outro(0, t.el[0]), h.off("mouseup" + m, t.outside), t.el.off("mouseleave" + m, t.leave), h.off(
                "mousemove" + m, t.moveOutside), window.clearTimeout(t.delayId), !n.delay || e) return t.complete();
      ...
      i.define("edit", t.exports = function (t, e, n) {
        ...
        return p ? h() : d.search ? (/[?&](edit)(?:[=&?]|$)/.test(d.search) || /\?edit$/.test(d.href)) && h() :
          c.on(f, r).triggerHandler(f), {}
      })
    }, function (t, e, n) {
      var i = n(0);
      i.define("forms", t.exports = function (t, e) {
        function r(e, n) {
          ...
          r.handler = null, r.redirect = i.attr("data-redirect"), T.test(s) ? r.handler = c : s || (p ? r.handler =
            u : O())
        }
        ...
        function s(e, n) {
          ...
          return n = n || {}, e.find(':input:not([type="submit"])').each(function (r, o) {
            ...
            "string" == typeof c && (c = t.trim(c)), n[u] = c, i = i || function (t, e, n, i) {
              var r = null;
              "password" === e ? r = "Passwords cannot be submitted." : t.attr("required") && (i ? (y.test(
                  n) || y.test(t.attr("type"))) && (x.test(i) || (r =
                  "Please enter a valid email address for: " + n)) : r =
        ...
        function u(e) {
          ...
          if (a(e), p) {
            ...
            w && c.indexOf("https://webflow.com") >= 0 && (c = c.replace("https://webflow.com",
              "http://formdata.webflow.com")), t.ajax({
              url: c,
              type: "POST",
              data: r,
              dataType: "json",
        ...
        function c(n) {
          ...
          if (!/^https/.test(g.href) || /^https/.test(n.action)) {
            ...
            e.each(r, function (t, e) {
              y.test(e) && (r.EMAIL = t), /^((full[ _-]?)?name)$/i.test(e) && (c = t),
                /^(first[ _-]?name)$/i.test(e) && (r.FNAME = t), /^(last[ _-]?name)$/i.test(e) && (r.LNAME =
                  t)
        ...
        return f.ready = f.design = f.preview = function () {
          p = t("html").attr("data-wf-site"), (h = t(b + " form")).length && h.each(r), _ || v || (v = !0, m.on(
            "submit", b + " form",
            function (e) {
              var n = t.data(this, b);
            ...
            if (r.crossDomain && r.async && n.test(r.type) && e.test(r.url) && i.test(r.url)) {
              ...
              return {
                send: function (e, n) {
                  ...
                  s = new XDomainRequest, /^\d+$/.test(o.timeout) && (s.timeout = o.timeout), s.ontimeout =
                    function () {
                      n(500, "timeout")
                    }, s.onload = function () {
                    ...
                    }, o.data && (i = "string" === t.type(o.data) ? o.data : t.param(o.data)), s.open(r.type,
                      r.url), s.send(i)
                },
                abort: function () {
                  s && s.abort()
      ...
      i.define("ix", t.exports = function (t, e) {
            ...
            l && (m.style(a, c.style), e.each(l, function (t) {
              ...
              if ("load" !== u) {
                if ("click" === u) return a.on("click" + w, function (e) {
                  i.validClick(e.currentTarget) && ("#" === a.attr("href") && e.preventDefault(), f(
                    t, a, {
                      group: o.clicked ? "B" : "A"
                    }), c && (o.clicked = !o.clicked))
                }), void(T = T.add(a));
                if ("hover" === u) return a.on("mouseenter" + w, e), a.on("mouseleave" + w, n), void(T =
                  T.add(a));
                if ("scroll" !== u) {
                  var l = j[u];
                  if (l) {
        ...
        function f(e, n, r, o) {
          ...
          if (!p || r.force) {
            ...
            if (d && d.length) {
              if (d.length < 2 && (l = !1), !o) {
                var v = e.selector;
                v && (n = e.descend ? n.find(v) : e.siblings ? n.siblings(v) : t(v), x && n.attr(
                  "data-ix-affect", 1)), k && n.addClass("w-ix-emptyfix"), u && n.css("transform-style",
                  "preserve-3d")
              }
              for (var m = b(n), g = {
                  omit3d: !u
        ...
        function h(t, e) {
          var n = e && e.omit3d,
            i = {},
            r = !1;
          for (var o in t) "transition" !== o && "keysort" !== o && (!n || "z" !== o && "rotateX" !== o &&
            "rotateY" !== o && "scaleZ" !== o) && (i[o] = t[o], r = !0);
          return r ? i : null
        }
        var p, v, m = {},
          g = t(window),
      ...
      function i(t, e, n, i) {
        function r(t, e) {
          return T = x(t) ? t : [t], w || r.build(), T.length > 1 && (w.items = w.empty, T.forEach(function (t) {
            ...
            w.items = w.items.add(n), c(t.thumbnailUrl || t.url, function (t) {
              t.prop("width") > t.prop("height") ? h(t, "wide") : h(t, "tall"), e.append(h(t,
                "thumbnail-image"))
            })
          }), w.strip.empty().append(w.items), h(w.content, "group")), y(p(w.lightbox, "hide").focus()).add(
            "opacity .3s").start({
            opacity: 1
        ...
        function u() {
          w && (w.strip.scrollLeft(0).empty(), p(w.html, "noscroll"), h(w.lightbox, "hide"), w.view && w.view.remove(),
            p(w.content, "group"), h(w.arrowLeft, "inactive"), h(w.arrowRight, "inactive"), g = w.view = void 0)
        }
        ...
        r.build = function () {
          return r.destroy(), w = {
              ...
              empty: n()
            }, w.arrowLeft = m("control left inactive"), w.arrowRight = m("control right inactive"), w.close = m(
              "control close"), w.spinner = m("spinner"), w.strip = m("strip"), b = new l(w.spinner, d("hide")),
            w.content = m("content").append(w.spinner, w.arrowLeft, w.arrowRight, w.close), w.container = m(
              "container").append(w.content, w.strip), w.lightbox = m("backdrop hide").append(w.container), w.strip
            .on("tap", f("item"), C), w.content.on("swipe", M).on("tap", f("left"), O).on("tap", f("right"), z).on(
              "tap", f("close"), E).on("tap", f("image, caption"), z), w.container.on("tap", f("view"), E).on(
              "dragstart", f("img"), a), w.lightbox.on("keydown", s).on("focusin", j), n(i).append(w.lightbox.prop(
              "tabIndex", 0)), r
        }, r.destroy = function () {
          ...
          if (t !== g) {
            ...
            return c(e.html && function (t, e) {
              ...
              function o() {
                if (b.hide(), t === g) {
                  if (v(w.arrowLeft, "inactive", t <= 0), v(w.arrowRight, "inactive", t >= T.length - 1), w.view ?
                    (y(w.view).add("opacity .3s").start({
                      opacity: 0
                    }).then(function (t) {
                      return function () {
                        t.remove()
              ...
              if (t === g) {
                var a, s, u = m("figure", "figure").append(h(r, "image")),
                  c = m("frame").append(u),
                  l = m("view").append(c);
                e.html && ((s = (a = n(e.html)).is("iframe")) && a.on("load", o), u.append(h(a, "embed"))), e
                  .caption && u.append(m("caption", "figcaption").text(e.caption)), w.spinner.before(l), s ||
                  o()
              }
            }), r
          }
        ...
        return l.prototype.show = function () {
          ...
          function () {
            function n() {
              var e = t.innerHeight,
                n = t.innerWidth,
                i = ".w-lightbox-content, .w-lightbox-view, .w-lightbox-view:before {height:" + e +
                "px}.w-lightbox-view {width:" + n +
                "px}.w-lightbox-group, .w-lightbox-group .w-lightbox-view, .w-lightbox-group .w-lightbox-view:before {height:" +
                .86 * e + "px}.w-lightbox-image {max-width:" + n + "px;max-height:" + e +
                "px}.w-lightbox-group .w-lightbox-image {max-height:" + .86 * e +
                "px}.w-lightbox-strip {padding: 0 " + .01 * e + "px}.w-lightbox-item {width:" + .1 * e +
                "px;padding:" + .02 * e + "px " + .01 * e + "px}.w-lightbox-thumbnail {height:" + .1 * e +
                "px}@media (min-width: 768px) {.w-lightbox-content, .w-lightbox-view, .w-lightbox-view:before {height:" +
                .96 * e + "px}.w-lightbox-content {margin-top:" + .02 * e +
                "px}.w-lightbox-group, .w-lightbox-group .w-lightbox-view, .w-lightbox-group .w-lightbox-view:before {height:" +
                .84 * e + "px}.w-lightbox-image {max-width:" + .96 * n + "px;max-height:" + .96 * e +
                "px}.w-lightbox-group .w-lightbox-image {max-width:" + .823 * n + "px;max-height:" + .84 * e +
                "px}}";
              o.textContent = i
            }
      ...
      r.define("lightbox", t.exports = function (t) {
        function e(t) {
          ...
          if (i) {
            ...
            }(i), (e = i.group) ? ((n = o[e]) || (n = o[e] = []), t.items = n, i.items.length && (t.index = n.length,
          ...
          webflowLightBox: function () {
            t.each(this, function (i, r) {
              ...
              o || (o = t.data(r, l, {
                ...
                images: [],
                embed: ""
              })), o.el.off(l), e(o), n ? o.el.on("setting" + l, e.bind(null, o)) : o.el.on("tap" +
                l,
                function (t) {
                  return function () {
      ...
      i.define("maps", t.exports = function (t, e) {
        function n() {
          function e() {
            window._wf_maps_loaded = function () {}, f = window.google, c.each(o), r(), i.resize.on(a), i.redraw
              .on(a)
          }(c = d.find(h)).length && (null === f ? (t.getScript(
            "https://maps.googleapis.com/maps/api/js?v=3.exp&sensor=false&callback=_wf_maps_loaded&key=" +
            p), window._wf_maps_loaded = e) : e())
        }
        ...
        function u(e, n) {
          ...
          r.map = new f.maps.Map(e, {
            ...
            t -= parseInt(n.paddingLeft, 10), t += parseInt(n.paddingRight, 10), e -= parseInt(n.paddingTop,
              10), e += parseInt(n.paddingBottom, 10), (t || e) && r.map.panBy(t, e), o.css("position", "")
          ...
          l && (r.tooltip = l, r.infowindow.setContent(l), r.infowindowOpen || (r.infowindow.open(r.map, r.marker),
            r.infowindowOpen = !0));
          var d = n.widgetStyle;
          d && r.map.setMapTypeId(d);
          var h = n.widgetZoom;
          return null != h && (r.zoom = h, r.map.setZoom(Number(h))), f.maps.event.addListener(r.marker,
            "click",
            function () {
      ...
      i.define("navbar", t.exports = function (t, e) {
        ...
        function a(n, r) {
          ...
          a || (a = t.data(r, T, {
              ...
              el: o,
              config: {}
            })), a.menu = o.find(".w-nav-menu"), a.links = a.menu.find(".w-nav-link"), a.dropdowns = a.menu.find(
              ".w-dropdown"), a.button = o.find(".w-nav-button"), a.container = o.find(".w-container"), a.outside =
            function (n) {
            ...
            }(a), a.el.off(T), a.button.off(T), a.menu.off(T), c(a), g ? (u(a), a.el.on("setting" + T, function (
              t) {
              return function (n, i) {
                i = i || {};
                var r = y.width();
        ...
        function c(t) {
          ...
          n.animOver = /^over/.test(r), n.animDirect = /left$/.test(r) ? -1 : 1, i.animation !== r && t.open &&
            e.defer(l, t), n.easing = t.el.attr("data-easing") || "ease", n.easing2 = t.el.attr("data-easing2") ||
            "ease";
        ...
        function f(t, e) {
          if (!t.open) {
            ...
            if (d(0, u), C.intro(0, u), i.redraw.up(), g || x.on("tap" + T, t.outside), !e) {
              ...
              if (t.overlay && (M = t.menu.prev(), t.overlay.show().append(t.menu)), n.animOver) return b(t.menu)
                .add(c).set({
                  x: n.animDirect * a,
                  height: r
                }).start({
        ...
        function h(t) {
          ...
          return e.animOver ? t.menu.height(n) : "fixed" !== t.el.css("position") && (n -= t.el.height()), t.overlay &&
        ...
        function p(t, e) {
          function n() {
            t.menu.height(""), b(t.menu).set({
              x: 0,
              y: 0
            }), t.menu.removeClass(z), t.links.removeClass(E), t.overlay && t.overlay.children().length && (M
              .length ? t.menu.insertAfter(M) : t.menu.prependTo(t.parent), t.overlay.attr("style", "").hide()
            ), t.el.triggerHandler("w-close")
          }
          if (t.open) {
            t.open = !1, t.button.removeClass(O);
            var i = t.config;
            if (("none" === i.animation || !b.support.transform || i.duration <= 0) && (e = !0), C.outro(0, t.el[
                0]), x.off("tap" + T, t.outside), e) return b(t.menu).stop(), void n();
        ...
        w.ready = w.design = w.preview = function () {
          g = k && i.env("design"), v = t(document.body), (m = x.find(T)).length && (m.each(a), n(), i.resize
            .on(o))
        }, w.destroy = function () {
      ...
      i.define("scroll", t.exports = function (t) {
        function e(e, n) {
          if (s.test(e)) {
            var u = t("#" + e);
            if (u.length) {
              if (n && (n.preventDefault(), n.stopPropagation()), o.hash !== e && a && a.pushState && (!i.env.chrome ||
                  "file:" !== o.protocol)) {
              ...
              r.setTimeout(function () {
                ! function (e, n) {
                  ...
                  var c = Date.now(),
                    l = r.requestAnimationFrame || r.mozRequestAnimationFrame || r.webkitRequestAnimationFrame ||
                    function (t) {
                      r.setTimeout(t, 15)
                    },
      ...
      i.define("slider", t.exports = function (t, e) {
        function n() {
          (w = T.find(z)).length && (w.filter(":visible").each(s), x = null, y || (o(), i.resize.on(a), i.redraw
            .on(k.redraw)))
        }
        ...
        function s(e, n) {
          ...
          if (r || (r = t.data(n, z, {
              ...
              el: i,
              config: {}
            })), r.mask = i.children(".w-slider-mask"), r.left = i.children(".w-slider-arrow-left"), r.right =
            i.children(".w-slider-arrow-right"), r.nav = i.children(".w-slider-nav"), r.slides = r.mask.children(
              ".w-slide"), r.slides.each(C.reset), x && (r.maskWidth = 0), !_.support.transform) return r.left.hide(),
            r.right.hide(), r.nav.hide(), void(y = !0);
          r.el.off(z), r.left.off(z), r.right.off(z), r.nav.off(z), u(r), b ? (r.el.on("setting" + z, p(r)), h(
            r), r.hasTimer = !1) : (r.el.on("swipe" + z, p(r)), r.left.on("tap" + z, l(r)), r.right.on("tap" +
            z, d(r)), r.config.autoplay && !r.hasTimer && (r.hasTimer = !0, r.timerCount = 1, f(r))), r.nav.on(
            "tap" + z, "> div", p(r)), O || r.mask.contents().filter(function () {
        ...
        function u(t) {
          var e = {};
          e.crossOver = 0, e.animation = t.el.attr("data-animation") || "slide", "outin" === e.animation && (e.animation =
            "cross", e.crossOver = .5), e.easing = t.el.attr("data-easing") || "ease";
          var n = t.el.attr("data-duration");
          if (e.duration = null != n ? parseInt(n, 10) : 500, c(t.el.attr("data-infinite")) && (e.infinite = !0),
            c(t.el.attr("data-disable-swipe")) && (e.disableSwipe = !0), c(t.el.attr("data-hide-arrows")) ? e.hideArrows = !
            0 : t.config.hideArrows && (t.left.show(), t.right.show()), c(t.el.attr("data-autoplay"))) {
            e.autoplay = !0, e.delay = parseInt(t.el.attr("data-delay"), 10) || 2e3, e.timerMax = parseInt(t.el
              .attr("data-autoplay-limit"), 10);
        ...
        function v(e, n) {
          ...
          var a = n.index,
            s = {};
          a < 0 ? (a = o.length - 1, r.infinite && (s.x = -e.endX, s.from = 0, s.to = o[0].width)) : a >= o.length &&
            (a = 0, r.infinite && (s.x = o[o.length - 1].width, s.from = -o[o.length - 1].x, s.to = s.from - s.x)),
            e.index = a;
          var u = e.nav.children().eq(e.index).addClass("w-active");
          e.nav.children().not(u).removeClass("w-active"), r.hideArrows && (e.index === o.length - 1 ? e.right.hide() :
        ...
        function g(e) {
          ...
          s < 0 && (s = 0), e.anchors = [{
            ...
            r && (r = parseFloat(r) + "px");
            for (var o = 0; o < e.pages; o++) n = t(E), e.nav.hasClass("w-num") && n.text(o + 1), null != r &&
              n.css({
                "margin-left": r,
                "margin-right": r
              }), i.push(n);
      ...
      n(0).define("touch", t.exports = function (t) {
        ...
        return i && (t.event.special.tap = {
          ...
          return i ? null : (n = "string" == typeof n ? t(n).get(0) : n) ? new function (t) {
            function n(t) {
              var e = t.touches;
              e && e.length > 1 || (l = !0, d = !1, e ? (f = !0, s = e[0].clientX, u = e[0].clientY) : (s =
                t.clientX, u = t.clientY), c = s)
            }
            ...
            function o(t) {
              if (l) {
                if (l = !1, f && "mouseup" === t.type) return t.preventDefault(), t.stopPropagation(), void(
                  f = !1);
                d || e("tap", t)
              }
            }
            ...
            t.addEventListener("touchstart", n, !1), t.addEventListener("touchmove", i, !1), t.addEventListener(
              "touchend", o, !1), t.addEventListener("touchcancel", a, !1), t.addEventListener(
              "mousedown", n, !1), t.addEventListener("mousemove", i, !1), t.addEventListener("mouseup",
              o, !1), t.addEventListener("mouseout", a, !1), this.destroy = function () {
              t.removeEventListener("touchstart", n, !1), t.removeEventListener("touchmove", i, !1), t.removeEventListener(
                "touchend", o, !1), t.removeEventListener("touchcancel", a, !1), t.removeEventListener(
                "mousedown", n, !1), t.removeEventListener("mousemove", i, !1), t.removeEventListener(
                "mouseup", o, !1), t.removeEventListener("mouseout", a, !1), t = null
            }
          }(n) : null
